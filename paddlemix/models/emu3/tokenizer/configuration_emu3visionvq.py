...
class Emu3VisionVQConfig(paddlenlp.transformers.configuration_utils.PretrainedConfig):
    """
    ...
    def __init__(self, codebook_size: int=32768, embed_dim: int=4,
        z_channels: int=4, double_z: bool=False, in_channels: int=3,
        out_channels: int=3, temporal_downsample_factor: int=4, ch: int=256,
        ch_mult: List[int]=[1, 2, 2, 4], num_res_blocks: int=2,
        attn_resolutions: List[int]=[3], dropout: float=0.0, **kwargs):
